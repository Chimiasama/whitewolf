...
# Replace renderStepContent markers
start_marker = '    const renderStepContent = () => {'
end_marker = '    if (view === \'home\') {'

start_idx = content.find(start_marker)
end_idx = content.find(end_marker)

new_rsc = r"""    const renderStepContent = () => {
...
content = content[:start_idx] + new_rsc + content[end_idx:]
