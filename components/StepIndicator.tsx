          ...
          return (
            ...
            >
              ...
              >
                ...
                <span className={`mt-2 w-full max-w-[4.5rem] sm:max-w-24 px-0.5 text-[8px] sm:text-[10px] uppercase tracking-wide sm:tracking-wider text-center leading-tight break-words transition-colors duration-300 ${bIsCurrent ? (isWerewolf ? 'text-emerald-400 font-bold' : 'text-red-400 font-bold') : 'text-gray-500'}`}>{sStepName}</span>
              </button>
            </li>
          );
        })}
