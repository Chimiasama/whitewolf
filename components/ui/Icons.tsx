...
export const BloodIcon: React.FC<{ className?: string, filled?: boolean }> = ({ className = "w-4 h-4", filled = true }) => (
    <svg
...
export const ClawIcon: React.FC<{ className?: string, filled?: boolean }> = ({ className = "w-4 h-4", filled = true }) => (
...
export const WolfCubIcon: React.FC<{ className?: string }> = ({ className = "w-4 h-4" }) => (
