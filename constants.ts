...
export const fnGetPredatorTypes = (fnT: TFunction): PredatorTypeDetail[] => [
    ...
    },
    {
        ...
        humanityModifier: 0,
        disciplineAdd: { discipline: "presence", dots: 1 }, // Official rules let the player pick Dominate or Presence; the app only grants Presence for now.
    ...
    },
    {
        ...
        advantages: [
            ...
            { id: 'remorseful_confidant', name: fnT('advantages.remorseful.name'), description: fnT('advantages.remorseful.description'), cost: 1, type: 'advantage', levels: [1] },
            { id: 'memoriam_dweller_confidant', name: fnT('advantages.memoriamdweller.name'), description: fnT('advantages.memoriamdweller.description'), cost: 1, type: 'advantage', levels: [1] }
        ],
    ...
    },
    {
        ...
        advantages: [{ id: 'clan_infiltrator_eattherich', name: fnT('advantages.claninfiltrator.name'), description: fnT('advantages.claninfiltrator.description'), cost: 3, type: 'advantage', levels: [3] }],
    ...
    },
    {
        ...
        advantages: [
            { id: 'efficient_eater_hideandeat', name: fnT('advantages.efficienteater.name'), description: fnT('advantages.efficienteater.description'), cost: 2, type: 'advantage', levels: [2] },
            { id: 'slippery_hideandeat', name: fnT('advantages.slippery.name'), description: fnT('advantages.slippery.description'), cost: 1, type: 'advantage', levels: [1] }
        ],
    ...
    },
    {
        ...
        advantages: [{ id: 'improved_ghouls_labrat', name: fnT('advantages.improvedghouls.name'), description: fnT('advantages.improvedghouls.description'), cost: 3, type: 'advantage', levels: [3] }],
        flaws: [
            { id: 'blunted_fangs_labrat', name: fnT('flaws.bluntedfangs.name'), description: fnT('flaws.bluntedfangs.description'), cost: 1, type: 'flaw', levels: [1] },
    ...
    },
    {
        ...
        humanityModifier: 0,
        disciplineAdd: { discipline: "fortitude", dots: 1 },
        advantages: [{ id: 'blood_healer_hospitalhunter', name: fnT('advantages.bloodhealer.name'), description: fnT('advantages.bloodhealer.description'), cost: 3, type: 'advantage', levels: [3] }],
    ...
    },
    {
        ...
        advantages: [{ id: 'loremaster_localhaunt', name: fnT('advantages.loremaster.name'), description: fnT('advantages.loremaster.description'), cost: 3, type: 'advantage', levels: [3] }],
    ...
    },
    {
        ...
        humanityModifier: 0,
        disciplineAdd: { discipline: "obfuscate", dots: 1 },
        advantages: [{ id: 'obscure_lurkerincrowd', name: fnT('advantages.obscure.name'), description: fnT('advantages.obscure.description'), cost: 3, type: 'advantage', levels: [3] }],
    ...
    },
    {
        ...
        humanityModifier: 0,
        disciplineAdd: { discipline: "presence", dots: 1 },
        advantages: [{ id: 'social_engineer_manicpixie', name: fnT('advantages.socialengineer.name'), description: fnT('advantages.socialengineer.description'), cost: 3, type: 'advantage', levels: [3] }],
    ...
    },
    {
        ...
        humanityModifier: 0,
        disciplineAdd: { discipline: "presence", dots: 1 },
        advantages: [{ id: 'delay_destruction_opportunist', name: fnT('advantages.delaydestruction.name'), description: fnT('advantages.delaydestruction.description'), cost: 3, type: 'advantage', levels: [3] }],
    ...
    },
    {
        ...
        humanityModifier: 0,
        disciplineAdd: { discipline: "protean", dots: 1 },
        advantages: [{ id: 'apex_predator_packhunter', name: fnT('advantages.apexpredator.name'), description: fnT('advantages.apexpredator.description'), cost: 3, type: 'advantage', levels: [3] }],
        flaws: [
    ...
    },
    {
        ...
        humanityModifier: 0,
        disciplineAdd: { discipline: "potence", dots: 1 },
        advantages: [{ id: 'danger_sense_streetfeeder', name: fnT('advantages.dangersense.name'), description: fnT('advantages.dangersense.description'), cost: 3, type: 'advantage', levels: [3] }],
    ...
    },
    {
        ...
        disciplineAdd: { discipline: "protean", dots: 1 },
        advantages: [
            { id: 'sharp_senses_watcher', name: fnT('advantages.sharpsenses.name'), description: fnT('advantages.sharpsenses.description'), cost: 2, type: 'advantage', levels: [2] },
            { id: 'slippery_watcher', name: fnT('advantages.slippery.name'), description: fnT('advantages.slippery.description'), cost: 1, type: 'advantage', levels: [1] }
        ],
    ...
    },
    {
        ...
        disciplineAdd: { discipline: "fortitude", dots: 1 },
        advantages: [
            { id: 'daredevil_wolf', name: fnT('advantages.daredevil.name'), description: fnT('advantages.daredevil.description'), cost: 3, type: 'advantage', levels: [3] },
            { id: 'underestimated_wolf', name: fnT('advantages.underestimated.name'), description: fnT('advantages.underestimated.description'), cost: 1, type: 'advantage', levels: [1] }
        ],
...
export const fnGetAdvantagesAndFlaws = (fnT: TFunction, gameType: GameType | null): AdvantageFlaw[] => {
    ...
    return [
        ...
        { id: 'calmheart', name: fnT('advantages.calmheart.name'), description: fnT('advantages.calmheart.description'), cost: 4, type: 'advantage', levels: [4] },
        { id: 'daredevil', name: fnT('advantages.daredevil.name'), description: fnT('advantages.daredevil.description'), cost: 3, type: 'advantage', levels: [3] },
        { id: 'codeofhonor', name: fnT('advantages.codeofhonor.name'), description: fnT('advantages.codeofhonor.description'), cost: 2, type: 'advantage', levels: [2] },
        { id: 'fastlearner', name: fnT('advantages.fastlearner.name'), description: fnT('advantages.fastlearner.description'), cost: 5, type: 'advantage', levels: [5] },
        { id: 'focused', name: fnT('advantages.focused.name'), description: fnT('advantages.focused.description'), cost: 1, type: 'advantage', levels: [1] },
        { id: 'headstrong', name: fnT('advantages.headstrong.name'), description: fnT('advantages.headstrong.description'), cost: 4, type: 'advantage', levels: [4] },
        { id: 'highhumanity', name: fnT('advantages.highhumanity.name'), description: fnT('advantages.highhumanity.description'), cost: 3, type: 'advantage', levels: [3] },
        { id: 'ironwill', name: fnT('advantages.ironwill.name'), description: fnT('advantages.ironwill.description'), cost: 4, type: 'advantage', levels: [4] },
        { id: 'jackofalltrades', name: fnT('advantages.jackofalltrades.name'), description: fnT('advantages.jackofalltrades.description'), cost: 4, type: 'advantage', levels: [4] },
        { id: 'expertinstructor', name: fnT('advantages.expertinstructor.name'), description: fnT('advantages.expertinstructor.description'), cost: 1, type: 'advantage', levels: [1] },
        { id: 'remorseful_merit', name: fnT('advantages.remorseful.name'), description: fnT('advantages.remorseful.description'), cost: 1, type: 'advantage', levels: [1] },
        { id: 'loremaster_merit_v', name: fnT('advantages.loremaster.name'), description: fnT('advantages.loremaster.description'), cost: 2, type: 'advantage', levels: [2] },
        { id: 'totalrecall', name: fnT('advantages.totalrecall.name'), description: fnT('advantages.totalrecall.description'), cost: 1, type: 'advantage', levels: [1] },
        { id: 'crackdriver', name: fnT('advantages.crackdriver.name'), description: fnT('advantages.crackdriver.description'), cost: 1, type: 'advantage', levels: [1] },
        { id: 'lightsleeper', name: fnT('advantages.lightsleeper.name'), description: fnT('advantages.lightsleeper.description'), cost: 3, type: 'advantage', levels: [3] },
        { id: 'sharpsenses', name: fnT('advantages.sharpsenses.name'), description: fnT('advantages.sharpsenses.description'), cost: 1, type: 'advantage', levels: [1] },
        { id: 'slippery_merit_v', name: fnT('advantages.slippery.name'), description: fnT('advantages.slippery.description'), cost: 1, type: 'advantage', levels: [1] },
        { id: 'skillaptitude', name: fnT('advantages.skillaptitude.name'), description: fnT('advantages.skillaptitude.description'), cost: 4, type: 'advantage', levels: [4] },
        { id: 'tough_merit', name: fnT('advantages.tough.name'), description: fnT('advantages.tough.description'), cost: 4, type: 'advantage', levels: [4] },
        { id: 'unstakeable', name: fnT('advantages.unstakeable.name'), description: fnT('advantages.unstakeable.description'), cost: 6, type: 'advantage', levels: [6] },
        { id: 'claninfiltrator_merit', name: fnT('advantages.claninfiltrator.name'), description: fnT('advantages.claninfiltrator.description'), cost: 3, type: 'advantage', levels: [3] },
        { id: 'inspiringpresence', name: fnT('advantages.inspiringpresence.name'), description: fnT('advantages.inspiringpresence.description'), cost: 1, type: 'advantage', levels: [1] },
        { id: 'prestigioussire', name: fnT('advantages.prestigioussire.name'), description: fnT('advantages.prestigioussire.description'), cost: 1, type: 'advantage', levels: [1] },
        { id: 'socialengineer_merit', name: fnT('advantages.socialengineer.name'), description: fnT('advantages.socialengineer.description'), cost: 3, type: 'advantage', levels: [3] },
        { id: 'stalwartloyalty', name: fnT('advantages.stalwartloyalty.name'), description: fnT('advantages.stalwartloyalty.description'), cost: 1, type: 'advantage', levels: [1] },
        { id: 'underestimated_merit_v', name: fnT('advantages.underestimated.name'), description: fnT('advantages.underestimated.description'), cost: 1, type: 'advantage', levels: [1] },
        { id: 'aftermealglow', name: fnT('advantages.aftermealglow.name'), description: fnT('advantages.aftermealglow.description'), cost: 1, type: 'advantage', levels: [1] },
        { id: 'alchemyexpert', name: fnT('advantages.alchemyexpert.name'), description: fnT('advantages.alchemyexpert.description'), cost: 5, type: 'advantage', levels: [5] },
        { id: 'animalaffinity', name: fnT('advantages.animalaffinity.name'), description: fnT('advantages.animalaffinity.description'), cost: 3, type: 'advantage', levels: [3] },
        { id: 'apexpredator_merit', name: fnT('advantages.apexpredator.name'), description: fnT('advantages.apexpredator.description'), cost: 3, type: 'advantage', levels: [3] },
        { id: 'berserker', name: fnT('advantages.berserker.name'), description: fnT('advantages.berserker.description'), cost: 3, type: 'advantage', levels: [3] },
        { id: 'bloodhealer_merit', name: fnT('advantages.bloodhealer.name'), description: fnT('advantages.bloodhealer.description'), cost: 3, type: 'advantage', levels: [3] },
        { id: 'delaydestruction_merit', name: fnT('advantages.delaydestruction.name'), description: fnT('advantages.delaydestruction.description'), cost: 3, type: 'advantage', levels: [3] },
        { id: 'dangersense_merit', name: fnT('advantages.dangersense.name'), description: fnT('advantages.dangersense.description'), cost: 3, type: 'advantage', levels: [3] },
        { id: 'demonicpact', name: fnT('advantages.demonicpact.name'), description: fnT('advantages.demonicpact.description'), cost: 5, type: 'advantage', levels: [5] },
        { id: 'diablerist', name: fnT('advantages.diablerist.name'), description: fnT('advantages.diablerist.description'), cost: 4, type: 'advantage', levels: [4] },
        { id: 'disciplinecompetence', name: fnT('advantages.disciplinecompetence.name'), description: fnT('advantages.disciplinecompetence.description'), cost: 6, type: 'advantage', levels: [6] },
        { id: 'efficienteater_merit', name: fnT('advantages.efficienteater.name'), description: fnT('advantages.efficienteater.description'), cost: 3, type: 'advantage', levels: [3] },
        { id: 'fasteater', name: fnT('advantages.fasteater.name'), description: fnT('advantages.fasteater.description'), cost: 3, type: 'advantage', levels: [3] },
        { id: 'fasthealer', name: fnT('advantages.fasthealer.name'), description: fnT('advantages.fasthealer.description'), cost: 4, type: 'advantage', levels: [4] },
        { id: 'friendtofae', name: fnT('advantages.friendtofae.name'), description: fnT('advantages.friendtofae.description'), cost: 3, type: 'advantage', levels: [3] },
        { id: 'holyaura', name: fnT('advantages.holyaura.name'), description: fnT('advantages.holyaura.description'), cost: 3, type: 'advantage', levels: [3] },
        { id: 'improvedghouls_merit', name: fnT('advantages.improvedghouls.name'), description: fnT('advantages.improvedghouls.description'), cost: 3, type: 'advantage', levels: [3] },
        { id: 'magicresistance', name: fnT('advantages.magicresistance.name'), description: fnT('advantages.magicresistance.description'), cost: 4, type: 'advantage', levels: [4] },
        { id: 'memoriamdweller_merit', name: fnT('advantages.memoriamdweller.name'), description: fnT('advantages.memoriamdweller.description'), cost: 1, type: 'advantage', levels: [1] },
        { id: 'obscure_merit_v', name: fnT('advantages.obscure.name'), description: fnT('advantages.obscure.description'), cost: 1, type: 'advantage', levels: [1, 2, 3, 4, 5] },
        { id: 'powerfulvitae', name: fnT('advantages.powerfulvitae.name'), description: fnT('advantages.powerfulvitae.description'), cost: 5, type: 'advantage', levels: [5] },
        { id: 'risingsun', name: fnT('advantages.risingsun.name'), description: fnT('advantages.risingsun.description'), cost: 3, type: 'advantage', levels: [3] },
        { id: 'spiritmentor', name: fnT('advantages.spiritmentor.name'), description: fnT('advantages.spiritmentor.description'), cost: 5, type: 'advantage', levels: [5] },
        { id: 'thaumaturgictraining', name: fnT('advantages.thaumaturgictraining.name'), description: fnT('advantages.thaumaturgictraining.description'), cost: 5, type: 'advantage', levels: [5] },
        { id: 'truebond', name: fnT('advantages.truebond.name'), description: fnT('advantages.truebond.description'), cost: 4, type: 'advantage', levels: [4] },
        { id: 'truefaith', name: fnT('advantages.truefaith.name'), description: fnT('advantages.truefaith.description'), cost: 6, type: 'advantage', levels: [6] },
        { id: 'truesight', name: fnT('advantages.truesight.name'), description: fnT('advantages.truesight.description'), cost: 1, type: 'advantage', levels: [1, 2, 3, 4, 5] },
        { id: 'mysticalitem', name: fnT('advantages.mysticalitem.name'), description: fnT('advantages.mysticalitem.description'), cost: 2, type: 'advantage', levels: [2] },
        ...
        { id: 'amnesia', name: fnT('flaws.amnesia.name'), description: fnT('flaws.amnesia.description'), cost: 5, type: 'flaw', levels: [5] },
        { id: 'curiosity', name: fnT('flaws.curiosity.name'), description: fnT('flaws.curiosity.description'), cost: 3, type: 'flaw', levels: [3] },
        { id: 'impatient', name: fnT('flaws.impatient.name'), description: fnT('flaws.impatient.description'), cost: 4, type: 'flaw', levels: [4] },
        { id: 'paranoia', name: fnT('flaws.paranoia.name'), description: fnT('flaws.paranoia.description'), cost: 2, type: 'flaw', levels: [2] },
        { id: 'routine', name: fnT('flaws.routine.name'), description: fnT('flaws.routine.description'), cost: 2, type: 'flaw', levels: [2] },
        { id: 'morbidfascination', name: fnT('flaws.morbidfascination.name'), description: fnT('flaws.morbidfascination.description'), cost: 3, type: 'flaw', levels: [3] },
        { id: 'nightmares', name: fnT('flaws.nightmares.name'), description: fnT('flaws.nightmares.description'), cost: 5, type: 'flaw', levels: [5] },
        { id: 'sadist', name: fnT('flaws.sadist.name'), description: fnT('flaws.sadist.description'), cost: 2, type: 'flaw', levels: [2] },
        { id: 'vengeful', name: fnT('flaws.vengeful.name'), description: fnT('flaws.vengeful.description'), cost: 4, type: 'flaw', levels: [4] },
        { id: 'weakwilled', name: fnT('flaws.weakwilled.name'), description: fnT('flaws.weakwilled.description'), cost: 2, type: 'flaw', levels: [2] },
        { id: 'softhearted', name: fnT('flaws.softhearted.name'), description: fnT('flaws.softhearted.description'), cost: 5, type: 'flaw', levels: [5] },
        { id: 'bluntedfangs', name: fnT('flaws.bluntedfangs.name'), description: fnT('flaws.bluntedfangs.description'), cost: 2, type: 'flaw', levels: [2] },
        { id: 'childlike', name: fnT('flaws.childlike.name'), description: fnT('flaws.childlike.description'), cost: 5, type: 'flaw', levels: [5] },
        { id: 'fleshofthecorpse', name: fnT('flaws.fleshofthecorpse.name'), description: fnT('flaws.fleshofthecorpse.description'), cost: 4, type: 'flaw', levels: [4] },
        { id: 'fragile', name: fnT('flaws.fragile.name'), description: fnT('flaws.fragile.description'), cost: 5, type: 'flaw', levels: [5] },
        { id: 'stenchofdeath', name: fnT('flaws.stenchofdeath.name'), description: fnT('flaws.stenchofdeath.description'), cost: 3, type: 'flaw', levels: [3] },
        { id: 'weakstomach', name: fnT('flaws.weakstomach.name'), description: fnT('flaws.weakstomach.description'), cost: 2, type: 'flaw', levels: [2] },
        { id: 'mistakenidentity', name: fnT('flaws.mistakenidentity.name'), description: fnT('flaws.mistakenidentity.description'), cost: 3, type: 'flaw', levels: [3] },
        { id: 'notorioussire', name: fnT('flaws.notorioussire.name'), description: fnT('flaws.notorioussire.description'), cost: 1, type: 'flaw', levels: [1] },
        { id: 'oathbreaker', name: fnT('flaws.oathbreaker.name'), description: fnT('flaws.oathbreaker.description'), cost: 1, type: 'flaw', levels: [1] },
        { id: 'outsider_flaw_v', name: fnT('flaws.outsider.name'), description: fnT('flaws.outsider.description'), cost: 2, type: 'flaw', levels: [2] },
        { id: 'brash_flaw_v', name: fnT('flaws.brash.name'), description: fnT('flaws.brash.description'), cost: 1, type: 'flaw', levels: [1] },
        { id: 'conflictingloyalties_flaw', name: fnT('flaws.conflictingloyalties.name'), description: fnT('flaws.conflictingloyalties.description'), cost: 2, type: 'flaw', levels: [2] },
        { id: 'dull_flaw_v', name: fnT('flaws.dull.name'), description: fnT('flaws.dull.description'), cost: 2, type: 'flaw', levels: [2] },
        { id: 'hunted', name: fnT('flaws.hunted.name'), description: fnT('flaws.hunted.description'), cost: 5, type: 'flaw', levels: [5] },
        { id: 'intolerance', name: fnT('flaws.intolerance.name'), description: fnT('flaws.intolerance.description'), cost: 4, type: 'flaw', levels: [4] },
        { id: 'markedfordeath', name: fnT('flaws.markedfordeath.name'), description: fnT('flaws.markedfordeath.description'), cost: 5, type: 'flaw', levels: [5] },
        { id: 'overconfident_flaw_v', name: fnT('flaws.overconfident.name'), description: fnT('flaws.overconfident.description'), cost: 3, type: 'flaw', levels: [3] },
        { id: 'twistedupbringing', name: fnT('flaws.twistedupbringing.name'), description: fnT('flaws.twistedupbringing.description'), cost: 4, type: 'flaw', levels: [4] },
        { id: 'angrybeast_flaw', name: fnT('flaws.angrybeast.name'), description: fnT('flaws.angrybeast.description'), cost: 2, type: 'flaw', levels: [2] },
        { id: 'appetizingblood', name: fnT('flaws.appetizingblood.name'), description: fnT('flaws.appetizingblood.description'), cost: 4, type: 'flaw', levels: [4] },
        { id: 'beaconofunholy', name: fnT('flaws.beaconofunholy.name'), description: fnT('flaws.beaconofunholy.description'), cost: 2, type: 'flaw', levels: [2] },
        { id: 'cannotembrace_flaw', name: fnT('flaws.cannotembrace.name'), description: fnT('flaws.cannotembrace.description'), cost: 2, type: 'flaw', levels: [2] },
        { id: 'cursed', name: fnT('flaws.cursed.name'), description: fnT('flaws.cursed.description'), cost: 2, type: 'flaw', levels: [2] },
        { id: 'eeriepresence_flaw', name: fnT('flaws.eeriepresence.name'), description: fnT('flaws.eeriepresence.description'), cost: 2, type: 'flaw', levels: [2] },
        { id: 'deathskiss_flaw', name: fnT('flaws.deathskiss.name'), description: fnT('flaws.deathskiss.description'), cost: 2, type: 'flaw', levels: [2] },
        { id: 'deepsleeper_flaw', name: fnT('flaws.deepsleeper.name'), description: fnT('flaws.deepsleeper.description'), cost: 1, type: 'flaw', levels: [1] },
        { id: 'disciplineinept', name: fnT('flaws.disciplineinept.name'), description: fnT('flaws.disciplineinept.description'), cost: 3, type: 'flaw', levels: [3] },
        { id: 'frigidaura_flaw', name: fnT('flaws.frigidaura.name'), description: fnT('flaws.frigidaura.description'), cost: 2, type: 'flaw', levels: [2] },
        { id: 'magicsusceptibility', name: fnT('flaws.magicsusceptibility.name'), description: fnT('flaws.magicsusceptibility.description'), cost: 4, type: 'flaw', levels: [4] },
        { id: 'grimwounds', name: fnT('flaws.grimwounds.name'), description: fnT('flaws.grimwounds.description'), cost: 3, type: 'flaw', levels: [3] },
        { id: 'repulsivetoanimals', name: fnT('flaws.repulsivetoanimals.name'), description: fnT('flaws.repulsivetoanimals.description'), cost: 3, type: 'flaw', levels: [3] },
        { id: 'taintofcorruption', name: fnT('flaws.taintofcorruption.name'), description: fnT('flaws.taintofcorruption.description'), cost: 3, type: 'flaw', levels: [3] },
        { id: 'taintedblood', name: fnT('flaws.taintedblood.name'), description: fnT('flaws.taintedblood.description'), cost: 5, type: 'flaw', levels: [5] },
        { id: 'thirstforinnocence', name: fnT('flaws.thirstforinnocence.name'), description: fnT('flaws.thirstforinnocence.description'), cost: 4, type: 'flaw', levels: [4] },
        { id: 'weakblood', name: fnT('flaws.weakblood.name'), description: fnT('flaws.weakblood.description'), cost: 5, type: 'flaw', levels: [5] },
        { id: 'curseditem', name: fnT('flaws.curseditem.name'), description: fnT('flaws.curseditem.description'), cost: 2, type: 'flaw', levels: [2] },
    ];
};
